...
public class CustomView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        textPaint.setColor(getContext().getResources().getColor(R.color.gplus_color_3));
        ...
        textPaint.setColor(getContext().getResources().getColor(R.color.gplus_color_2));
        textPaint.setTextSize(textSize);
        ...
        textPaint.setColor(getContext().getResources().getColor(R.color.gplus_color_4));
